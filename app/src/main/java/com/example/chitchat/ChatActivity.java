...
public class ChatActivity extends AppCompatActivity {
    private static final int DOCUMENT_PICK =2 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mCurrentUserId !=null && mChatUser!=null) {
            ...
            DatabaseReference mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child(mChatUser);
            ...
            mChatAddBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    CharSequence options[] = new CharSequence[]{"Image", "Documents"};
                    ...
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (i == 1) {
                                ...
                                startActivityForResult(Intent.createChooser(intent, "Document"), DOCUMENT_PICK);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == GALLERY_PICK && resultCode == RESULT_OK){
        ...
        else if (requestCode == DOCUMENT_PICK && resultCode == RESULT_OK){
            Uri imageUri = data.getData();
            ...
            StorageReference filepath = mImageStorage.child("message_documents").child( push_id + ".pdf");
